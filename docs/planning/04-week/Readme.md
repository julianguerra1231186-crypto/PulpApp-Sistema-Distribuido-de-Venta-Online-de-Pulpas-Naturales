...
- Realizamos los diagramas de flujo para tener mucha mas claridad 
- Teniendo en cuenta las actividades en los Week se dearrollo una lina de tiempo para ver el avanze que tenemos en el proyecto

![](https://github.com/julianguerra1231186-crypto/PulpApp-Sistema-Distribuido-de-Venta-Online-de-Pulpas-Naturales/blob/main/docs/planning/04-week/LineaDeTiempo.png)

<hr>

# se designaron los Rols en el equipo y sus funciones por medio de la mesa de trabajo Mesa De Trabajo 
